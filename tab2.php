		...
		<div class="row">
            <div class="col-xs-12 col-md-12 col-lg-12">
              <div class="box box-solid box-default">
                <div class="box-header with-border">
                  <h3 class="box-title"><?php //echo $row['exam_name']; ?>UCE Results</h3>
                </div><!-- /.box-header -->
                <div class="box-body table-responsive">		
...
-->                        <div class="pull-left">
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="2"><b>Grade Aggregate:</b> 
                           ...
                           <tr>
                            <td colspan="2">
                            <a href="get_combination.php?studentId=<?php echo $row['student_id']; ?>" class="button button-primary pull-right" title="Get Combination for - <?php echo ucwords(strtolower($row['student_surname']." ".$row['student_othernames'])); ?>"> Get Combination <i class="fa fa-arrow-circle-right" style="color:#33CC66;"></i></a>
                            </td>
                          </tr>
                        </tfoot>
                        </table>
