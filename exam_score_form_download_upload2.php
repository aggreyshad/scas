		  ...
		  <form name="manage_exam_score" id="manage_exam_score" class="manage_exam_score" action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" >
            ...
            <div class="box-body">
				<div class="row">
                    ...
                    <div class="form-group col-lg-3 col-md-3" id="select_term" style="display: <?php echo (isset($_REQUEST['term']) && $_REQUEST['term'] !='')? 'block' : 'none'; ?>;">
                ...
                <!-- select only s4-->
                    <div class="form-group col-lg-3 col-md-3" id="class_4" style="display: <?php echo (isset($_REQUEST['class_id_4']) && $_REQUEST['class_id_4'] !='')? 'block' : 'none'; ?>;">					
                ...
                <!-- select only s6-->
                    <div class="form-group col-lg-3 col-md-3" id="class_6" style="display: <?php echo (isset($_REQUEST['class_id_6'])&& $_REQUEST['class_id_6'] !='')? 'block' : 'none'; ?>;">					
					 <label for="class_id">Select Class</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                ...
                <!-- select All classes-->
                    <div class="form-group col-lg-3 col-md-3" id="all_classes" style="display: <?php echo (isset($_REQUEST['class_id'])&& $_REQUEST['class_id'] !='')? 'block' : 'none'; ?>;">					
					 <label for="class_id">Select Class</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                    ...
                    <!-- select O Level-->
                    <div class="form-group col-lg-3 col-md-3"  id="o_level" style="display: <?php echo (isset($_REQUEST['subject_id_o']) && $_REQUEST['subject_id_o'] !='')? 'block' : 'none'; ?>;">					
					...
					<!-- select A Level-->
                    <div class="form-group col-lg-3 col-md-3"  id="a_level" style="display:<?php echo (isset($_REQUEST['subject_id_a'])&& $_REQUEST['subject_id_a'] !='')? 'block' : 'none'; ?>;">					
