...
?>
 ...
 <div class="row">
		...
		<?php }
          ...
          <!-- Default box -->
          <div class="box box-solid box-success" style="display:<?php echo (isset($visible)&& $visible==false)? 'none' : 'block'; ?>;">
		  <form name="manage_exam_score" id="manage_exam_score" class="manage_exam_score" action="insert_marks_imported.php" method="post" enctype="multipart/form-data" >
            ...
            <div class="box-body">
				<div class="row">
					 ...
					 <label for="exam_id">Select Exam</label>
					 		...
					 		<div class="input-group-addon"><i class="fa fa-gears"></i></div>
                      		<select class="form-control" id="exam_id" name="exam_id" onchange="classCheck(this);">
								...
								?>
                        		<option value="<?php printf($row['exam_id']); ?>"><?php echo($row['exam_name']); ?></option>
            					<?php }
								}?>
                     		</select>
					  		</div> 
                	...
                	<div class="form-group col-lg-3 col-md-3">			
					 ...
					 <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                      <input type="text" class="form-control" id="year_of_exam" name="year_of_exam" placeholder="Enter Year Of Exam">
					  </div>
                    </div>
                    
                    <!-- Term  in which exam was done ie 1, 2 or 3. -->
                    <div class="form-group col-lg-3 col-md-3" id="select_term" style="display: none;">
                ...
                <!-- select only s4-->
                    <div class="form-group col-lg-3 col-md-3" id="class_4" style="display: none;">					
                ...
                <!-- select only s6-->
                    <div class="form-group col-lg-3 col-md-3" id="class_6" style="display: none;">					
					 <label for="class_id">Select Class</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                ...
                <!-- select All classes-->
                    <div class="form-group col-lg-3 col-md-3" id="all_classes" style="display: none;">					
					 <label for="class_id">Select Class</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                    ...
                    <!-- select O Level-->
                    <div class="form-group col-lg-3 col-md-3"  id="o_level" style="display: none;">					
					 <label for="subject_id">Select Subject</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                      <select class="form-control select2" id="subject_id_o" name="subject_id_o" data-placeholder="Select a Subject"  style="width:100%;" >
					  	<option value="">Please Select</option>
					...
					<!-- select A Level-->
                    <div class="form-group col-lg-3 col-md-3"  id="a_level" style="display: none;">					
					 <label for="subject_id_a">Select Subject</label>
					 <div class="input-group">
					 <div class="input-group-addon"><i class="fa fa-file-text-o"></i></div>
                      <select class="form-control select2" id="subject_id_a" name="subject_id_a" data-placeholder="Select a Subject" style="width:100%;">
					  	<option value="">Please Select</option>
					  	<option value="*">* All Subjects</option>
          ...
          <?php //only appears after you have gotten a marksheet to import ( after you have exported a marksheet)
    		if(isset($visible)&& $visible==false) { include 'import_mark_sheet_form.php';}
			?>
