...
CREATE TABLE IF NOT EXISTS `career_cat` (
  `career_cat_id` int(11) NOT NULL AUTO_INCREMENT,
  `career_cat_name` varchar(225) NOT NULL,
  PRIMARY KEY (`career_cat_id`)
...
CREATE TABLE IF NOT EXISTS `coursesubject` (
  `coursesubject_id` int(11) NOT NULL AUTO_INCREMENT,
  `course_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cuttoffpoints` (
  `cuttOffPoints_id` int(11) NOT NULL AUTO_INCREMENT,
  `course_id` int(11) NOT NULL,
  `year` year(4) NOT NULL,
  `points` int(11) NOT NULL,
  PRIMARY KEY (`cuttOffPoints_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;
...
(88, 5, 29, 4, 2014, 3, 4, 100, 1),
(89, 5, 44, 4, 2014, 3, 4, 77, 2),
(90, 5, 35, 4, 2014, 3, 4, 65, 4),
(91, 5, 36, 4, 2014, 3, 4, 61, 5),
(92, 5, 48, 4, 2014, 3, 4, 59, 6),
(93, 5, 49, 4, 2014, 3, 4, 62, 5),
(94, 5, 50, 4, 2014, 3, 4, 64, 5),
(95, 5, 32, 4, 2014, 3, 4, 58, 6),
(96, 5, 63, 4, 2014, 3, 4, 60, 5),
(97, 18, 29, 4, 2014, 3, 4, 71, 3),
(98, 18, 44, 4, 2014, 3, 4, 65, 4),
(99, 18, 35, 4, 2014, 3, 4, 63, 5),
(100, 18, 36, 4, 2014, 3, 4, 66, 4),
(101, 18, 48, 4, 2014, 3, 4, 82, 1),
(102, 18, 49, 4, 2014, 3, 4, 79, 2),
(103, 18, 50, 4, 2014, 3, 4, 71, 3),
(104, 18, 30, 4, 2014, 3, 4, 70, 3),
(105, 18, 64, 4, 2014, 3, 4, 72, 3),
(106, 18, 51, 4, 2014, 3, 4, 89, 1),
(107, 19, 29, 4, 2014, 3, 4, 90, 1),
(108, 19, 44, 4, 2014, 3, 4, 73, 3),
(109, 19, 35, 4, 2014, 3, 4, 77, 2),
(110, 19, 36, 4, 2014, 3, 4, 75, 2),
(111, 19, 48, 4, 2014, 3, 4, 58, 6),
(112, 19, 49, 4, 2014, 3, 4, 78, 2),
(113, 19, 50, 4, 2014, 3, 4, 99, 1),
(114, 19, 63, 4, 2014, 3, 4, 68, 4),
(115, 19, 32, 4, 2014, 3, 4, 64, 5),
(116, 5, 56, 4, 2014, 3, 4, 76, 2),
(117, 20, 29, 4, 2014, 3, 4, 100, 1),
(118, 20, 44, 4, 2014, 3, 4, 78, 2),
(119, 20, 32, 4, 2014, 3, 4, 73, 3),
(120, 20, 35, 4, 2014, 3, 4, 68, 4),
(121, 20, 36, 4, 2014, 3, 4, 62, 5),
(122, 20, 48, 4, 2014, 3, 4, 71, 3),
(123, 20, 49, 4, 2014, 3, 4, 62, 5),
(124, 20, 50, 4, 2014, 3, 4, 73, 3),
(125, 20, 51, 4, 2014, 3, 4, 66, 4),
(126, 1, 42, 1, 2014, 3, 1, 45, 8),
(127, 2, 42, 1, 2014, 3, 1, 94, 1),
(128, 1, 65, 1, 2017, 1, 1, 89, 1),
(129, 2, 65, 1, 2017, 1, 1, 88, 1),
(130, 3, 65, 1, 2017, 1, 1, 5, 9),
(131, 4, 65, 1, 2017, 1, 1, 52, 7),
(132, 6, 65, 1, 2017, 1, 1, 66, 4),
(133, 7, 65, 1, 2017, 1, 1, 5, 9),
(134, 8, 65, 1, 2017, 1, 1, 50, 7),
(135, 9, 65, 1, 2017, 1, 1, 45, 8);
...
INSERT INTO `student` (`student_id`, `student_surname`, `student_othernames`, `class_id`, `stream`, `sex`, `dob`, `student_email`, `o_level_index`, `a_level_index`, `nationality`, `level`, `student_password`, `admission_date`, `student_photofile`, `combination_id`) VALUES
(1, 'Isaakwa', 'Peter', 1, 'A', 'M', '1991-06-02', 'isaakwapeter@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 09:27:50', '', 0),
(2, 'Muhammad', 'Irfan', 1, 'A', 'M', '1991-12-01', 'mouhammadirfan@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 09:27:50', '', 0),
(3, 'Kate', 'Noah', 1, 'A', 'M', '1991-01-01', 'katenoah@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 09:27:50', '', 0),
(4, 'Mulinda', 'Sadat', 1, 'A', 'M', '1988-01-01', 'sadat@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 09:27:50', '', 0),
(5, 'kiryowa', 'moses', 6, 'B', 'M', '1993-02-23', 'moses@ab.com', '', '', 'Uganda', 'A', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 14:37:59', '', 2),
(6, 'komakeche', 'Peter', 1, 'A', 'M', '1992-04-02', 'koma@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 15:03:24', '', 0),
(7, 'katamba', 'Irfan', 1, 'A', 'M', '1988-04-04', 'katamba@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 15:03:25', '', 0),
(8, 'ssegirinya', 'Noah', 1, 'A', 'M', '1989-04-04', 'noah@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 15:03:25', '', 0),
(9, 'lutankome', 'Sadat', 1, 'A', 'M', '1994-04-02', 'llsadat@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-19 15:03:25', '', 0),
(10, 'Hawumba', 'Jonah', 2, 'A', 'M', '1999-02-02', 'jonah_hawumba@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-21 17:06:26', '', 0),
(11, 'Obbo', 'Francis', 4, 'A', 'M', '1991-02-02', 'francisobbo@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-30 14:53:47', '', 7),
(12, 'Mawerere', 'Lawrence', 4, 'A', 'M', '1991-07-22', 'mawererelawrence@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-30 14:55:42', '', 0),
(13, 'Kasamba', 'Esther', 4, 'A', 'F', '1991-04-02', 'kasambaesther@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-30 14:57:20', 'uploads/abeja.png', 0),
(14, 'Ibiara', 'Sara', 4, 'A', 'M', '1990-06-22', 'ibiarasara@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-30 14:58:33', '', 0),
(15, 'Kayizi', 'Joshua', 4, 'A', 'M', '1990-04-01', 'kayizijoshua@gmail.com', '', '', 'Kazakhstan', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-03-30 15:00:06', '', 0),
(16, 'Luwambo', 'Raymond', 4, 'A', 'M', '1997-06-15', 'luwambo11@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-04-10 17:18:56', '', 0),
(17, 'Iporotum', 'Jeff', 4, 'A', 'M', '1994-06-08', 'jeffiporotum@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-05-13 15:49:14', '', 0),
(18, 'Obote', 'Joel', 5, 'A', 'M', '1999-02-03', 'obotej@gmail.com', '', '', 'Uganda', 'A', 'e9fd588b5872543d86c44e763356a495', '2016-06-06 17:39:53', '', 0),
(19, 'Ngobi', 'Timothy', 4, 'A', 'M', '1999-02-02', 'timothy@gmail.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-06-06 22:00:53', '', 0),
(20, 'Katebe', 'Dina', 4, 'B', 'F', '1985-02-13', 'ka@yahoo.com', '', '', 'Uganda', 'O', 'e9fd588b5872543d86c44e763356a495', '2016-09-16 12:22:56', '', 0);
...
(4, 'Entrepreneurship Education', 'ENT.E', 'A', 2, 'P230'),
...
(31, 'Fasihi ya Kiswahili', 'KSW', 'O', 2, '218'),
...
(37, 'Political Education', 'PED', 'O', 2, '285'),
(38, 'Latin', 'LAT', 'O', 3, '301'),
(39, 'German', 'GER', 'O', 3, '309'),
(40, 'French', 'FRE', 'O', 3, '314'),
(41, 'Luganda', 'LUG', 'O', 3, '335'),
(42, 'Lugha ya Kiswahili', 'KSW.L', 'O', 3, '336'),
(43, 'Arabic Language', 'ARA', 'O', 3, '337'),
(44, 'Mathematics', 'MTC', 'O', 4, '456'),
(45, 'Additional Mathematics', 'ADM', 'O', 4, '475'),
(46, 'General Science', 'GSC', 'O', 5, '500'),
(47, 'Agriculture: Principles & Practice.', 'AGR', 'O', 5, '527'),
(48, 'Physics', 'PHY', 'O', 5, '535'),
(49, 'Chemistry', 'CHE', 'O', 5, '545'),
(50, 'Biology', 'BIO', 'O', 5, '553'),
(51, 'Art', 'ART', 'O', 6, '610'),
(52, 'Music', 'MUS', 'O', 6, '621'),
(53, 'Health Education', 'HED', 'O', 6, '631'),
(54, 'Clothing & Textile', 'CLO', 'O', 6, '652'),
(55, 'Foods & Nutrition', 'FNT', 'O', 6, '662'),
(56, 'Home Management', 'HMT', 'O', 6, '672'),
(57, 'Woodwork', 'WWK', 'O', 7, '732'),
(58, 'Technical Drawing', 'TDR', 'O', 7, '735'),
(59, 'Metalwork', 'MWK', 'O', 7, '742'),
(60, 'Building Construction', 'BGC', 'O', 7, '743'),
(61, 'Electricity & Electronics', 'EEC', 'O', 7, '751'),
(62, 'Power & Energy', 'PEG', 'O', 7, '752'),
(63, 'Commerce', 'COM', 'O', 9, '800'),
(64, 'Principles of Accounts', 'ACC', 'O', 9, '810'),
(65, 'Shorthand', 'SHD', 'O', 9, '820'),
(66, 'Typewriting', 'TYP', 'O', 9, '831'),
(67, 'Office Practice', 'OFP', 'O', 9, '835'),
(68, 'Computer Studies', 'CST', 'O', 9, '840'),
(69, 'Entrepreneurship Skills', 'ENT', 'O', 9, '845');
...
CREATE TABLE IF NOT EXISTS `subjectcombination` (
  `subject_combination_id` int(11) NOT NULL AUTO_INCREMENT,
  `combination_id` int(11) NOT NULL,
  `subject_id` int(11) NOT NULL,
...
(15, 'haumba', 'Haumba Samuel', 'haumba@gmail.com', 'e9fd588b5872543d86c44e763356a495', '2017-01-10 17:41:18', '+256 778 856138', 0, '');
